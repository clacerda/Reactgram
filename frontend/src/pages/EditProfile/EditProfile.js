  ...
  return (
    <div id='edit-profile'>
        ...
        <form onSubmit={handleSubmit}>
                ...
                <label>
                    <span>Bio:</span>
                    <input type="text" name="" placeholder='Descrição de perfil' id=""  onChange={(e) => setBio(e.target.value)} value={bio || ""}/>
                </label>
                <label>
                    <span>Quer alterar sua senha?</span>
                    <input type="password" name="" placeholder='Digite uma nova senha' id=""  onChange={(e) => setPassword(e.target.value)} value={password || ""} />
                </label>
